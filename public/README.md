# Euroclear Resource management rewritten in Angular5 and Bootstrap 4

Simple Dashboard Admin App built using Angular 5 and Bootstrap 4

This project is Powered by [StartAngular](http://startangular.com/) & [StrapUI](http://strapui.com/)
...
```bash
$ git clone https://github.com/laxminarasimha/ecrm5.git
$ cd public
